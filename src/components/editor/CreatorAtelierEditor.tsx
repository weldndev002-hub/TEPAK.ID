                        ...
                        <section className="flex-1 overflow-y-auto px-3 md:px-12 py-6 no-scrollbar bg-white z-10 pb-32 min-w-0">
                            <div className="max-w-xl mx-auto space-y-8 md:space-y-12">
                                ...
                                <div className="text-center md:text-left px-1">
                                    <span className="text-[8px] md:text-[10px] font-black text-primary uppercase tracking-[0.3em] md:tracking-[0.4em]">Page Configuration</span>
                                    <h2 className="text-xl sm:text-2xl md:text-4xl font-black text-slate-900 tracking-tight md:tracking-tighter mt-2 md:mt-4 uppercase break-words px-2">Design Your Canvas</h2>
                                    <p className="text-slate-400 mt-2 text-[9px] md:text-sm font-medium italic opacity-80 px-4">Customize your Orbit Site landing page with editorial blocks.</p>
                                </div>
                                ...
                                <div className="bg-slate-50 border border-slate-100 rounded-[1.5rem] md:rounded-[2.5rem] p-3 md:p-10">
                                    <div className="flex items-center justify-between mb-4 md:mb-10 gap-1 md:gap-2">
                                        <h3 className="font-black text-slate-900 text-xs md:text-xl tracking-tighter uppercase truncate">Profile Identity</h3>
                                        <span className="bg-primary text-white text-[7px] md:text-[9px] px-2 py-1 rounded-full font-black uppercase tracking-widest leading-none shrink-0 scale-90 md:scale-100">Required</span>
                                    </div>
                                    <div className="space-y-4 md:space-y-8">
                                        <div className="flex flex-col items-center gap-5 md:gap-8 p-3 md:p-10 bg-white rounded-[1.2rem] md:rounded-[2rem] border border-slate-100 shadow-sm">
                                            ...
                                            <div className="w-full space-y-4 md:space-y-6">
                                                <div>
                                                    <label className="text-[9px] md:text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] md:tracking-[0.3em] block mb-2 md:mb-3">Subdomain Host</label>
                                                ...
                                                <div>
                                                    <label className="text-[9px] md:text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] md:tracking-[0.3em] block mb-2 md:mb-3">Bio Description</label>
                                                    <textarea 
                                ...
                                <div className="space-y-4 md:space-y-8">
                                    <div className="flex items-center justify-between gap-1 md:gap-2">
                                        <h3 className="font-black text-slate-900 text-xs md:text-xl tracking-tighter uppercase truncate">Content Blocks</h3>
                                        <button 
                                ...
                                <div className="pt-10 md:pt-12 border-t border-slate-100 px-1 md:px-0">
                                    <h3 className="font-black text-slate-900 text-sm md:text-xl tracking-tighter uppercase mb-6 md:mb-8">Themes & Aesthetics</h3>
                                ...
                                <div className="pb-16 pt-6">
                                    <Button variant="amber" size="lg" className="w-full py-5 md:py-6 text-[10px] md:text-[11px] uppercase tracking-[0.3em] md:tracking-[0.4em] rounded-2xl md:rounded-[1.5rem] shadow-2xl shadow-amber-500/20">
                                        Publish Changes
                                    </Button>
                                </div>
                            </div>
