            ...
            <div className="w-full max-w-xl animate-in fade-in slide-in-from-bottom-8 duration-1000">
                <Card className="p-0 border-rose-100 shadow-[0_50px_100px_-20px_rgba(225,29,72,0.1)] overflow-hidden bg-white rounded-[3rem]">
                    ...
                    <div className="p-12 md:p-16 text-center">
                        ...
                        {/* TEXT CONTENT */}
                        <h1 className="text-3xl md:text-4xl font-black text-slate-900 tracking-tighter mb-4 uppercase leading-none">Access Restricted</h1>
                        ...
                        <div className="space-y-6 mb-12">
                            <div className="p-8 bg-slate-50/50 rounded-[2rem] border border-slate-100 text-left">
                                <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.4em] mb-4">Suspension Case</h3>
                                <p className="text-slate-600 font-medium leading-relaxed tracking-tight">
                                    Your account has been <span className="text-rose-600 font-black underline underline-offset-8 decoration-rose-200">Permanently Banned</span> due to repeated violations of our community guidelines.
                                </p>
                            </div>
 
                            <div className="bg-primary/5 p-8 rounded-[2.5rem] border border-dashed border-primary/20 flex flex-col items-center">
                                <p className="text-slate-500 text-[11px] font-black uppercase tracking-widest mb-6 opacity-60">Think this decision was made in error?</p>
