...
export const EditProductDashboard = () => {
    ...
    return (
        <div className="flex-1 flex flex-col min-h-screen bg-[#F8FAFC]">
            {/* TopNavBar Replacement Local Context (Or handled globally, but here is a local Page Header) */}
            <header className="sticky z-40 bg-white/70 backdrop-blur-md flex justify-between items-center w-full px-8 py-4 shadow-[0px_20px_40px_rgba(16,27,50,0.06)]">
                <div className="flex items-center gap-4">
                    <a href="/products" className="text-slate-500 hover:text-slate-800 transition-colors">
                        <span className="material-symbols-outlined">arrow_back</span>
                    </a>
                    <h2 className="text-xl font-black text-[#162138] tracking-tight">Edit Digital Product</h2>
                </div>
                            ...
                            <Card className="p-8 shadow-[0px_20px_40px_rgba(16,27,50,0.04)] border-none">
                                ...
                                <div className="border-2 border-dashed border-slate-300 rounded-2xl bg-slate-50 p-10 text-center group hover:border-[#465f89]/50 transition-all cursor-pointer">
                                    <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto shadow-sm mb-4 group-hover:scale-110 transition-transform">
                                        <span className="material-symbols-outlined text-[#465f89] text-3xl">cloud_upload</span>
                                    </div>
                        ...
                        <div className="space-y-8">
                            ...
                            <Card className="p-6 shadow-[0px_20px_40px_rgba(16,27,50,0.04)] border-none">
                                ...
                                <div className="relative group aspect-square rounded-2xl overflow-hidden bg-slate-50 mb-4">
                                    <img className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCFFfO0u3ABzaB5B6QVhNOFAv9wmpw2FE2IXeDpmfjmvxHPhy39x-T7Pzl9pxTZBSfuehl-5mcwrRoczZ9UohNhPnjIKHJswbQIU235Vv_OQDsYKjPkCaqhMD8u5BCxI6c_qTEf4HCdeL9HXok2xC_WaAlnM8Oz2BENBYgIPvorFlJEY6J-m2PET-FsOXaApOH1RTasb6E5KDXjLel-5WYiHgGxbax7lGpMQEUfLaVtnPnHdPMx_ZxXcPV6PeKHaebSt1QAWXI_Ii7K"/>
                                <div className="absolute inset-0 bg-[#005ab4]/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                        <button className="bg-white text-[#005ab4] px-4 py-2 rounded-full text-xs font-bold flex items-center">
                                            <span className="material-symbols-outlined text-sm mr-2">edit</span>
                                            Change Image
                                        </button>
                                    </div>
                                </div>
                                <p className="text-[10px] text-slate-500 leading-relaxed text-center italic">Recommended size: 1080x1080px (1:1)</p>
                            </Card>
                            ...
                            {/* Quick Actions */}
                            <div className="p-6 bg-[#0873df] rounded-2xl text-white overflow-hidden relative">
                                ...
                                <span className="material-symbols-outlined absolute -right-4 -bottom-4 text-7xl text-white/10 rotate-12">help_center</span>
                            </div>
