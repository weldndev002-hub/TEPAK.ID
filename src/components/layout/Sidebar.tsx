...
export const Sidebar: React.FC<SidebarProps> = ({ activePage = 'dashboard' }) => {
  return (
    <aside className="flex flex-col h-screen fixed left-0 top-0 z-50 w-64 bg-[#162138] text-white font-['Plus_Jakarta_Sans',sans-serif] antialiased overflow-hidden border-r border-white/5">
      <div className="p-7 mb-6 flex flex-col justify-center">
        <h1 className="text-2xl font-black text-white tracking-tighter uppercase">tepak.id</h1>
        <p className="text-[10px] font-black text-blue-400 uppercase tracking-[0.2em] mt-1">Admin Command Center</p>
      </div>
