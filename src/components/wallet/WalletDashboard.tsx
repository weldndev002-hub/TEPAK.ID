...
const WalletDashboardContent = () => {
    ...
    if (error) {
        return (
            <div className="max-w-7xl w-full mx-auto p-12 text-center space-y-6">
                ...
                <div className="md:col-span-1 relative overflow-hidden bg-slate-900 rounded-[2.5rem] p-8 flex flex-col justify-between shadow-2xl shadow-slate-900/20 group">
                    ...
                    <div className="mt-8">
                        ...
                        >
                            ...
                            {balanceData.available < minWithdrawal ? 'Saldo Tidak Cukup' : 'Tarik Saldo'}
                        </Button>
                    </div>
                </div>
                                                ...
                                                <TableCell>
                                                    <Badge 
                                                        variant={
                                                            ...
                                                            tx.status === 'PENDING' ? 'pending' : 'destructive'
                                                        }
                                                    >
